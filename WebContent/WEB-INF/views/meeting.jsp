...
<body>
 ...
 <ul class="nav nav-pills flex-column">
        <li class="nav-item">
		 <button class="btn btn-light">   <a class="nav-link" href="${ct}meeting/look?mstate=1" target="middleframe" >会议列表</a></button>
        </li>
		  <li class="nav-item">
		 <button class="btn btn-light">   <a class="nav-link" href="${ct}meeting/meetingAdd" target="middleframe">添加会议</a></button>
        </li>
...
<iframe name="middleframe" class="embed-responsive-item" style="width:100%" src="${ct}meeting/look?mstate=1"></iframe>
</div>
