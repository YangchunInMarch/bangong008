					...
					<ul class="nav nav-pills flex-column">
						<li class="nav-item">
							<button class="btn btn-light">
								<a class="nav-link" href="${ct}notice/noticeAdd" target="middleframe">发布公告</a>
							</button>
						</li>
						<li class="nav-item">
							<button class="btn btn-light">
								<a class="nav-link" href="${ct}notice/noticeList" target="middleframe">公告列表</a>
							</button>
						</li>
			...
			<div class="col-sm-10">
				<div class="embed-responsive  embed-responsive-4by3">
					<iframe name="middleframe" class="embed-responsive-item"
						style="width: 100%;" src="${ct}notice/noticeList"></iframe>
				</div>
